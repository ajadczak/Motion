...
public:
	...
	/// deprecated. Use XMFLOAT4 instead of XMCOLOR
	///</summary>
	//static D3DX11INLINE DirectX::XMCOLOR ToXmColor(DirectX::FXMVECTOR v)
	//{
	//	DirectX::XMCOLOR dest;
	//	DirectX::XMStoreColor(&dest, v);
	//	return dest;
	//}
